<%-- projectMyBatis/src/main/webapp/member/memberLogInForm.jsp --%>
...
<body>
<div id="login-jsp">
	<a href="../index.jsp"><img src="../image/mangom2.jpg" width="150" height="150" alt="mangom" /></a>
	<h2>로그인</h2>
