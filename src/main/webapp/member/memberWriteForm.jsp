<%-- projectMyBatis/src/main/webapp/member/memberWriteForm.jsp --%>
...
<div id="write-jsp">
	...
	<h2>회원가입</h2>
	<form name="memberWriteForm" onsubmit="return memberWrite()" action="./memberWrite.jsp" method="post">
		<table>
			<tr>
		    ...
		    <tr>
		        ...
		        <td class="input">
		           ...
		           <button type="button" onclick="checkId()" id="checkBtn">중복검사</button>
		    ...
		    <tr>
		        ...
		        <td class="input">
		           ...
		           <input type="text" id="addr1" name="addr1" placeholder="주소" readonly/>
